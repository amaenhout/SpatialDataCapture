function mapproportion(countryselect, category){
	function getColor(d) {
  ...
  //called but not plotted
	...
	if (countryselect == "europe"){
		...
		var	mymap = new L.map('map-canvas',{ zoomControl: true}).setView([50.6, 4.438212], 8);
	}
	else if (countryselect == "france"){
		var	mymap = new L.map('map-canvas',{ zoomControl: true}).setView([46.5, 3], 6);
	}
	...
	// }
		...
		var	mymap = new L.map('map-canvas',{ zoomControl: true}).setView([46.8, 8.3], 8);
	}
	else if (countryselect == "brussels"){
		var	mymap = new L.map('map-canvas',{ zoomControl: true}).setView([50.837, 4.352412], 12);
	}
	else if (countryselect == "bruges"){
		var	mymap = new L.map('map-canvas',{ zoomControl: true}).setView([51.22, 3.224382], 11);
	}
	else if (countryselect == "geneva"){
		var	mymap = new L.map('map-canvas',{ zoomControl: true}).setView([46.205945, 6.141384], 13);
	}
	else if (countryselect == "paris"){
		var	mymap = new L.map('map-canvas',{ zoomControl: true}).setView([48.856876, 2.341254], 12);
	}
	else if (countryselect == "vienna"){
		var	mymap = new L.map('map-canvas',{ zoomControl: true}).setView([48.209390, 16.370096], 11);
	}
	...
	minZoom: 4, maxZoom: 14}).addTo(mymap);
